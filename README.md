...
(1) Präzisierung der IT-Grundschutz Checks (GSC) und der nachfolgenden Kommunikation und Behebung der Befunde

(2) Reduzierung der Aktualisierungsaufwänden verursacht durch eine jährlich neue Edition des IT-GS-Kompendiums
...
Der Lösungsansatz besteht darin, jede Teilanforderung in einen Vektor zu überführen und die Kosinus-Ähnlichkeit als Maß der Ähnlichkeit zu verwenden (Ignoriert werden hierbei die Wortreihenfolge, bestimmte Stoppwörter und die Zeichensetzung).
